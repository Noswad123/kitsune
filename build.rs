...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=KITSUNE_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=KITSUNE_BUILD_ID");
    println!("cargo:rerun-if-env-changed=KITSUNE_BUILD_COMMIT");
