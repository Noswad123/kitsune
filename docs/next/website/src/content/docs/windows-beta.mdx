...
For internal beta testing, `KITSUNE_MANIFEST_URL` can point the installer at a custom manifest instead of Herdr's stable or preview manifest.
...
- Whether you used a named `KITSUNE_SESSION`.
- Relevant Herdr logs.
